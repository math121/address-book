...
public class AddressRepository {
    ...
    public AddressRepository() {
        ...
        addressBook.add(new Address(112,"John", "Karken", "Kalis",
                "Dronning gate 12", 45678123, "john.karken@gmail.com", 34587567, 234412));
        addressBook.add(new Address(113,"Stella", "Tare", "Smart",
                "Jernbanetorget", 98712234, "stella.tare@outlook.com", 9889912, 7456234));
        addressBook.add(new Address(114, "Anya", "Floyer", "HP",
                "Olsens gate 6", 98712334, "anya.floyer@hotmail.com", 12399002, 345654));
    }
